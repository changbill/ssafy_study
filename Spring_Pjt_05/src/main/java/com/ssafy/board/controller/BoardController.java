...
public class BoardController extends HttpServlet {
	...
	@GetMapping("/board/")
	@ApiOperation(value = "게시글 조회", notes = "검색조건도 넣으면 같이 가져온다. 하지만 넣지 않겠다.")
	public ResponseEntity<?> list(@RequestParam int video_id) {
		List<Board> list = boardService.getList(video_id);
	...
	public ResponseEntity<Void> delete(@PathVariable int id, int video_id) {
		boardService.removeBoard(id, video_id);
