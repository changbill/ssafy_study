...
import com.ssafy.backend.dao.________;
...
public class UserDaoImpl implements UserDao{
	...
	public boolean insertUser(User user) throws SQLException {
		String sql = "INSERT INTO user (id, password, name, email, age) VALUES (?,?,?,?,?)";
	...
	public int userCount() throws SQLException {
		String sql = "UPDATE user SET ???cnt = ???cnt+1 WHERE id = ?";
